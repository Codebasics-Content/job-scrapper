"""Test Naukri with 20 jobs for description & skill validation (≤80 lines)"""
...
def test_naukri_validation() -> None:
    """Test Naukri: 20 jobs with description & skill validation"""
    logger.info("="*70)
    logger.info("🧪 NAUKRI VALIDATION TEST: 20 Jobs")
    logger.info("="*70)
    
    start = datetime.now()
    
    # Scrape 20 jobs from Naukri
