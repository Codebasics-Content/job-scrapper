...
from src.scraper.results.processing.aggregator import JobAggregator
from src.scraper.results.statistics.calculator import StatisticsCalculator
from src.scraper.results.reporting.formatter import ReportFormatter
...
class ResultsManager:
    ...
    def __init__(self) -> None:
        self.aggregator: JobAggregator = JobAggregator()
    ...
    def generate_statistics_report(self) -> dict[str, object]:
        """
    ...
    def export_results_summary(self) -> str:
        ...
        return self.formatter.format_summary(stats)
