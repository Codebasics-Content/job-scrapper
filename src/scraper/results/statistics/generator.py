...
class StatisticsGenerator:
    ...
    def generate_report(self, jobs: list[JobModel]) -> dict[str, object]:
        ...
        return {
            ...
            "top_companies": [job.company for job in jobs[:10]],
    ...
    def _generate_summary(self, jobs: list[JobModel], 
        ...
        return {
            ...
            "average_skills_per_job": sum(len(job.normalized_skills) if job.normalized_skills else 0
