...
class SkillsValidator:
    ...
    def __init__(self, reference_file: str = "skills_reference_2025.json"):
    ...
    def _load_reference(self) -> None:
        ...
        try:
            with open(self.reference_file, 'r', encoding='utf-8') as f:
                ...
                logger.info(f"✅ Loaded {len(self.valid_skills)} valid skills from reference")
        except Exception as e:
            logger.error(f"Failed to load skills reference: {e}")
            self.valid_skills = set()
    
    def validate_skills(self, extracted_skills: str, min_confidence: float = 0.5) -> Tuple[str, bool]:
        """
        ...
        valid_skills = [
            ...
            if skill.lower() in self.valid_skills
        ]
